...
Para $p = 37$ (situación \textbf{S1}) tenemos que $a = 6$ y $b = 30.$ De acuerdo con esto los elementos de los conjuntos \eqref{eq::conjuntos}  tomando $x \equiv 6 \mod{37}$ y $y \equiv 30 \mod{37}$ son todos múltiplos de $37$ no divisibles por $2$ ni por $3.$
